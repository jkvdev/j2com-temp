...
<div
	...
	<div class="row">
		...
		<div class="col-sm-6">
			...
			// Run plugins before image display
		...
		<div class="col-sm-6">
			...
			// If plugins after title display exist
			...
			<div class="price-sku-brand-container row">
				...
				<div class="col-sm-6">
					...
					// If before display content plugins exist
...
<?php
// If product up sells are enabled
if (
